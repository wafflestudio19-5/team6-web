const dummyData = [
  ...
  },
  {
    ...
    article: "산지 2년된 따끈따끈한 에어팟 프로 상태 멀쩡합니다 노이즈 캔슬링 잘 됩니다 본체 뒤쪽에만 흠집이 있습니다 앞쪽에도 있긴합니다 철가루 약간 있는데 티안나요 ㅎㅎ 아 또 그리고 음 신도림 대림 구로디지털단지 신대방 신림 봉천 서울대입구역 낙성대역 사당 방배 서초 교대 강남 역삼 선릉 삼성 종합운동장 잠실새내나루 강변 구의 직거래 원해요 쿨거래 해드리면 아이스크림 하나 사드립니다",
    price: 100000,
    time: "3분 전",
    temperature: 36.5,
    category: "디지털기기",
